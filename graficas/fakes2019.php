...
$query = "SELECT SUBSTR(cuando,1,(instr(cuando,','))-1) as MES, SUBSTR(cuando,(instr(cuando,',')+1), 4) AS ANO, COUNT(*) AS TOTAL FROM bdatos WHERE CUANDO LIKE '%%2019' GROUP BY ANO, MES ORDER BY TOTAL DESC LIMIT 4";
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Porcentaje de Fake News publicadas por meses en campaña electoral del año 2019.'
    },
    accessibility: {
        point: {
            valueSuffix: '%'
